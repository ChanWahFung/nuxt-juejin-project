  ...
  <div class="login-modal-container">
    <div class="login-form">
      ...
      <div class="login-pancel">
        ...
        <el-input class="password-input" v-model="password" type="password" placeholder="请输入密码" maxlength="64"  @focus="currentFocus='password'" @blur="currentFocus=''" @keydown.enter="login"></el-input>
